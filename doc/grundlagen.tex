...
Um solche nicht linear-separierbare Probleme zu lösen müssen mehrere Perzeptrons hintereinander geschaltet werden.
...
Um die Limitation auf lineare Klassifikation eines einzelnen Perzeptrons zu überwinden kann man mehrere davon hintereinander schalten. 
...
Das heißt zwar, dass es theoretisch für jede Funktion ein Netz gibt, das sie beschreiben kann, in der Praxis muss man dieses Netz aber finden und dann auch trainieren können.
