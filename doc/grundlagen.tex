...
[Absatz über das TableSort System]
...
Die kleinste Einheit eines neuronalen Netzes ist das Perzeptron, wie es 1958 von Frank Rosenblatt beschrieben wurde \todo{Quelle}.
...
Die Eingabe wird in ein Input Layer 

\subsection{Backpropagation}

\todo{ein Absatz über lernen mit dem Backpropagation Algorithmus}
Der Backpropagation Algorithmus ist 

\subsection{Rekurrente neuronale Netze}

\todo{Text über rekurrente Netzwerke - Do I really need that?}