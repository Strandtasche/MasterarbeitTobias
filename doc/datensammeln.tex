...
\todo[inline]{Rutschenkonfiguration Tablesort erwähnen?}
...
Um diese zu bestimmten, müssen zunächst die Dateien rekonstruiert werden um gewöhnliche RGB-Bilder zu erhalten.
Dieser Vorgang wird mittels \textit{demosaicing} genannt.
