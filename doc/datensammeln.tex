...
Diese aus den aufgenommenen Bildern zu bestimmten ist das Ziel dieser Pipeline.
...
bevor diese noch einmal bezüglich der Sinnhaftigkeit ihrer Größe und Form gefiltert werden. 
...
So verlässlich sind die Partikelpositionen bei den selbstaufgenommen Daten nicht.
...
\begin{figure}
	...
	\caption[Beispiel Feature-Label-Paar NextStep]{An diesem Ausschnitt eines Tracks wird beispielhaft mit FeatureSize 5 gezeigt, wie die einzelnen Feature-Label-Paare entstehen.
...
% Gradientenabstieg
stark gewichtet werden, werden sie standardisiert.
