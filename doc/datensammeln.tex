...
Zudem existieren Datensatze, die durch eine Simulation mittels der \textit{Diskrete-Elemente-Methode} (DEM) entstanden sind. 
...
Die Einheit des Orts, die in den beiden Datensatztypen verwendet wird, ist nicht identisch.
Die Simulation verwendet metrische Einheiten und gibt die Position auf dem Band in Metern an,
während die Position der Partikel bei den selbst aufgenommenen Daten in Pixeln bestimmt wird.
...
Solch ein Gefälle zwischen den Labelelementen würde zum Beispiel auftreten, wenn sich die Werte des einen Elements im Bereich zwischen 0 und 1700 bewegen, während die des Anderen zwischen 1 und 25 liegen,
