...
Was die Reihenfolge angeht, so ist sie für das neuronale Netz irrelevant, solange sie konsistent zwischen Training und Evaluation bleibt.
...
Um zu verhindern, dass verschiedene Dimensionen basierend auf ihrer Skalierung beim Training unterschiedlich 
% Gradientenabstieg
