...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{implementation01v5.pdf}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.75\textwidth]{implementation02v3.pdf}
...
Weder \(L_1\)- noch \(L_2\)-Regularisierung haben einen positiven Effekt auf die Trainingsergebnisse, weshalb für die NextStep-Netze darauf verzichtet wurde.
