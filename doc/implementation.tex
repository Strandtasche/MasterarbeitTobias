...
Diese Fehler werden dann analysiert, Durchschnitt, Median und Quartile werden gebildet und dann mittels Boxplots und Histogrammen visualisiert.
...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries separatorPosition}, labelindent=0.5cm]
    ...
    \item [separator] Hyperparameter, der festlegt, welcher Typ von Netz trainiert werden soll. Für NextStep Netze steht hier 0 und für Separator Netze 1.
\end{description}
