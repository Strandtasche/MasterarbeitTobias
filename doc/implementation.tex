...
Die Struktur des Codes, der für die Evaluation verantwortlich ist, ist in Abbildung~\ref{fig:impl02} dargestellt. 
...
Es werden Durchschnitt, Median und Quartile gebildet und dann mittels Boxplots und Histogrammen visualisiert.
...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries separatorPosition}, labelindent=0.5cm]
    ...
    \item [hiddenLayers] Ein Array an Zahlen, das die Architektur der Hidden Layers repräsentiert. Jede Zahl steht für ein Fully-Connected Layer mit der entsprechenden Anzahl Neuronen.
...
\begin{description}[leftmargin=!,labelwidth=\widthof{\bfseries separatorPosition}, labelindent=0.5cm]
    ...
    \item [separator] Hyperparameter, der festlegt, welche für welche Art von Aufgabe das Netz trainiert werden soll. Für NextStep Netze steht hier 0 und für Separator Netze 1.
\end{description}
