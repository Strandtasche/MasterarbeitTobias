...
\begin{document}
    ...
    \begin{abstract}
        The addition of area scan cameras to optical bulk material sorters enables an improvement in sorting quality by better predicting particle movement. 
        ...
        For this purpose, several datasets of selected bulk materials were collected on the Fraunhofer IOSB's experimental optical belt sorter \textit{TableSort} and preprocessed for training.
        These datasets were collected using two different configurations of the belt sorter. 
        A data augmentation method suitable for the problem was implemented and %good hyperparameters for training in the different scenarios were determined.
        and the hyperparameters for the training of the different scenarios were optimized.

        The evaluation was carried out on the datasets obtained in this way as well as on existing ones 
        ...
        Particularly on the collected data, an improvement compared to the reference methods was achieved .
    \end{abstract}
    ...
    \includepdf[pages=-]{AufgabenBlattRotiert.pdf}
