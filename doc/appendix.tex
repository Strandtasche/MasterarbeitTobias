...
\begin{figure}[h]
    \centering
	\includegraphics[width=0.8\textwidth]{appendix/SimulatedCuboid-evaluation_NextStep_LocationError_2018-12-10_19-08-06.pdf}
    \caption{Boxplots für die NextStep-Ergebnisse der Plättchen aus dem DEM-Datensatz.}
\end{figure}
